...
return NextResponse.json({success:true,message:"Data loaded successfully",status:200,data:asdata});
}
catch(err){
...
export const POST = async (req, res) => {
    ...
    let findd = await SubmittedAssignments.findOne({asid:asid,crid:crid,userid:userid});
    if(findd!=null){
